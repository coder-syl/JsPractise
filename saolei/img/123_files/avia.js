	...
	var win			= $(window),
		...
		{	
			...
			try{
				...
				css_block.remove();
				css_block = $("<css type='text/css' id='av-browser-width-calc'>"+css+"</css>").appendTo('head:first');
			}
		...
		{
			css_block = $("<css type='text/css' id='av-browser-width-calc'></css>").appendTo('head:first')
