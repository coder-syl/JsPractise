...
{	
    ...
    {	
		...
		$('.avia-bg-css-fixed').avia_mobile_fixed();
...
$.fn.avia_mobile_fixed = function(options)
{
	...
	return this.each(function()
	{
		var current				= $(this).addClass('av-parallax-section'),
			...
			template = "<div class='av-parallax " + $attachment_class + "' data-avia-parallax-ratio='0.0' css = '" + $background + "' ></div>";
...
$.fn.avia_browser_height = function()
{
	...
	var win			= $(window),
		...
		css_block	= $("<css type='text/css' id='av-browser-height'></css>").appendTo('head:first'),
		...
		calc_height = function()
		{
			...
			try{
				...
				css_block.remove();
				css_block = $("<css type='text/css' id='av-browser-height'>"+css+"</css>").appendTo('head:first');
			}
...
$.fn.avia_video_section = function()
{
	...
	var elements	= this.length, content = "",
		win			= $(window),
		css_block	= $("<css type='text/css' id='av-section-height'></css>").appendTo('head:first'),
		calc_height = function(section, counter)
		{
			...
			if(elements == counter + 1)
			{
				...
				try{
					...
					css_block.remove();
					css_block = $("<css type='text/css' id='av-section-height'>"+content+"</css>").appendTo('head:first');
				}
			}
		};
